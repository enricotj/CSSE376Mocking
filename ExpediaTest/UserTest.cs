...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2000, 1, 1), new DateTime(2000, 2, 1), 10);
            var remainingFlight = new Flight(new DateTime(2000, 1, 15), new DateTime(2000, 2, 11), 5);
